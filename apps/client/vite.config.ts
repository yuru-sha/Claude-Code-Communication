...
export default defineConfig({
  ...
  resolve: {
    alias: {
      '@claude-communication/types': path.resolve(__dirname, '../../packages/types/src'),
      '@claude-communication/ui': path.resolve(__dirname, '../../packages/ui/src'),
      '@claude-communication/utils': path.resolve(__dirname, '../../packages/utils/src'),
    }
  },
  root: '.',
  build: {
