...
export interface DetailedSystemHealth {
  ...
  agentStatuses: {
    president: 'online' | 'offline' | 'error';
    boss1: 'online' | 'offline' | 'error';
    worker1: 'online' | 'offline' | 'error';
    worker2: 'online' | 'offline' | 'error';
    worker3: 'online' | 'offline' | 'error';
  };
