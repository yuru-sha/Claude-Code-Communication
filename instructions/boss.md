...
## 作業ディレクトリ管理
### プロジェクトごとの共通作業場所
- **ルート**: `/workspace/projects/`
- **プロジェクトディレクトリ**: `/workspace/projects/[プロジェクト名]`
- **命名規則**: 英数字とハイフン（例: `ecommerce-site`, `todo-app`）
- **重要**: 全 worker が同じディレクトリで作業することで、ファイルの共有と統合が容易になります

### ディレクトリ構造例
```
/workspace/projects/ecommerce-site/
...
```bash
# プロジェクト開始時に作成
cat > /workspace/projects/[プロジェクト名]/MASTER_TASKS.md << 'EOF'
# プロジェクト: [プロジェクト名]
## 目標: [PRESIDENT の要求]
...
3. **具体的指示（10 分以内）**
   ...
   - 期限と品質基準を設定
   - 成果物の形式を指定
   - **作業ディレクトリを明確に指定（/workspace/projects/プロジェクト名）**
...
【作業ディレクトリ】/workspace/projects/[プロジェクト名]
※必ずこのディレクトリで作業してください。存在しない場合は作成してください。

【タスク】[UI コンポーネント名]の実装
【納期】[YYYY/MM/DD HH:MM]
【成果物】
- /workspace/projects/[プロジェクト名]/components/ファイル名.jsx
- /workspace/projects/[プロジェクト名]/tests/[テストファイル]
- /workspace/projects/[プロジェクト名]/stories/[Storybook 設定]
...
【納期】[YYYY/MM/DD HH:MM]
【成果物】
- /workspace/projects/[プロジェクト名]/api/v1/エンドポイント名
- /workspace/projects/[プロジェクト名]/docs/openapi.yaml
- /workspace/projects/[プロジェクト名]/tests/integration/[テストファイル]
...
【納期】[YYYY/MM/DD HH:MM]
【成果物】
- /workspace/projects/[プロジェクト名]/.github/workflows/deploy.yml
- /workspace/projects/[プロジェクト名]/Dockerfile
- /workspace/projects/[プロジェクト名]/docker-compose.yml
- /workspace/projects/[プロジェクト名]/scripts/deploy.sh
...
# 1. 完了タスクをマスターリストで更新
echo "✅ $WORKER_NAME: [完了タスク名] - $(date)" >> /workspace/projects/[プロジェクト名]/progress.log
...
cat > /workspace/projects/[プロジェクト名]/TASK_QUEUE.md << 'EOF'
# タスクキュー管理表
...
成果物:
- /workspace/projects/[プロジェクト名]/components/Dashboard.tsx
- /workspace/projects/[プロジェクト名]/components/Dashboard.test.tsx
- /workspace/projects/[プロジェクト名]/styles/dashboard.css
